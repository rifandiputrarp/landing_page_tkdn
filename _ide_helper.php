...
namespace  { 
             ...
             * @static 
             */ 
            public static function addSubSelect($column, $query)
            {
                                return \Illuminate\Database\Eloquent\Builder::addSubSelect($column, $query);
            }
             ...
             * @static 
             */ 
            public static function defaultSelectAll()
            {
                                return \Illuminate\Database\Eloquent\Builder::defaultSelectAll();
            }
             ...
             * @static 
             */ 
            public static function joinRelation($relationName, $operator = '=')
            {
                                return \Illuminate\Database\Eloquent\Builder::joinRelation($relationName, $operator);
            }
             ...
             * @static 
             */ 
            public static function leftJoinRelation($relationName, $operator = '=')
            {
                                return \Illuminate\Database\Eloquent\Builder::leftJoinRelation($relationName, $operator);
            }
            ...
            {
                                return \Illuminate\Database\Eloquent\Builder::map($callback);
            }
