            ...
            <div class="mb-6">
                <div class="row mb-6 align-items-center">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <h3 class="font-size-6 mb-0">Data Master <span>(<?php echo e($count_company); ?>)</span></h3>
                    </div>
                    <div class="col-lg-6">
                        <div class="d-flex flex-wrap align-items-center justify-content-lg-end">
                            <div class="h-px-48 form-inline">
                                ...
                                <?php if($search): ?>
                                    <a href="<?php echo e(url()->current()); ?>" class="ml-5 btn btn-danger"
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="border border-color-2">
                                        ...
                                        <td class="table-y-middle px-6 pr-7">
                                            <div class="">
                                                <form method="POST"
                                                    action="<?php echo e(route('companies.destroy', $company->id)); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <a href="<?php echo e(route('companies.destroy', $company->id)); ?>" onclick="event.preventDefault();
                                                        Swal.fire({
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\landing_page_tkdn\resources\views/admin/data-master-list.blade.php ENDPATH**/ ?>